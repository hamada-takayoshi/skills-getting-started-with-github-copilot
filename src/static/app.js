            ...
            <ul class="participant-list">
              ${details.participants.length
                ? details.participants
                    .map(
                      (email) =>
                        `<li><span class="participant-email">${email}</span><button type="button" class="remove-participant-button" data-activity="${name}" data-email="${email}" aria-label="Remove ${email}">✕</button></li>`
                    )
                    .join("")
